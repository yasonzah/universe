...
public class SignupTest {
  ...
  @Test
  public void signup() {
    driver.get("http://127.0.0.1:7000/sign-up");
    driver.manage().window().setSize(new Dimension(1552, 832));
    driver.findElement(By.id("sign-up__first-name")).click();
    driver.findElement(By.id("sign-up__first-name")).sendKeys("Test");
    driver.findElement(By.id("sign-up__last-name")).click();
    driver.findElement(By.id("sign-up__last-name")).sendKeys("Test");
    driver.findElement(By.id("sign-up__email")).click();
    driver.findElement(By.id("sign-up__email")).sendKeys("testtesttest@test.com");
    driver.findElement(By.id("sign-up__password")).click();
    driver.findElement(By.id("sign-up__password")).sendKeys("Qwerty123$");
    driver.findElement(By.id("sign-up__confirm-password")).click();
    driver.findElement(By.id("sign-up__confirm-password")).sendKeys("Qwerty123$");
